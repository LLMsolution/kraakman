        ...
        >
          {duplicatedReviews.map((review, index) => (
            <div
              ...
              data-review-card
              className="flex-shrink-0 border border-foreground p-6 transition-all duration-300 cursor-pointer flex flex-col bg-background"
              style={{
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-foreground border-opacity-20">
