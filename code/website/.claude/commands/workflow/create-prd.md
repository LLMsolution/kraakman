...
After writing the PRD, create `.agents/STATUS.md` (or update if it exists):

1. Extract all features/capabilities from the PRD's "MVP Scope" and "Tools/Features" sections
2. List each as a row in the features table with status `backlog`
3. Use this template:
...
| Feature | Status | Plan | PR | Updated |
|---------|--------|------|----|---------|
| [Feature 1] | backlog | — | — | — |
| [Feature 2] | backlog | — | — | — |
...
## Recent Activity
- [date]: Project initialized, PRD created
```
...
2. Confirm STATUS.md was created with features listed
3. Provide a brief summary of the PRD contents
4. Highlight any assumptions made due to missing information
5. Suggest next steps (e.g., review, refinement, planning)
