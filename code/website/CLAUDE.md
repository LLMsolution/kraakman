...
- **Project ID**: `asqamsbnrjldkxievcmj`
- **Region**: EU North-1
...
mcp__supabase__list_tables(project_id="asqamsbnrjldkxievcmj")
mcp__supabase__execute_sql(project_id="asqamsbnrjldkxievcmj", query="SELECT * FROM cars;")
mcp__supabase__apply_migration(project_id="asqamsbnrjldkxievcmj", name="migration_name", query="ALTER TABLE cars ADD COLUMN new_field TEXT;")
```