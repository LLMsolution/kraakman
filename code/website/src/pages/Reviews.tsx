...
const Reviews = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Klantervaringen & Google Reviews"
        description={`Lees ${totalReviews || ''} klantervaringen over Auto Service van der Waals. ${averageRating ? `Gemiddelde score: ${averageRating.toFixed(1)}/5 sterren.` : ''} Bekijk wat onze klanten zeggen.`}
        path="/reviews"
      />
      <Navigation />
      ...
      >
        <div className="container-wide text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">{pageHeaders?.reviews_title || "Klantbeoordelingen"}</h1>
          <p className="text-lg sm:text-xl opacity-90 mb-4">
            {pageHeaders?.reviews_subtitle || "Wat onze klanten over ons zeggen"}
          </p>
